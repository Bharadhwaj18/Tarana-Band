      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="/merch" className="hover:text-white transition">Merchandise</a></li>
              <li><a href="/videos" className="hover:text-white transition">Videos</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href="/contact" className="hover:text-white transition">Contact Form</a></li>
              <li><a href="mailto:info@tarana.band" className="hover:text-white transition">Email</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 pt-8">
          <p className="text-center text-gray-400">
            © {currentYear} Tarana. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
